...
public class OrderingBot extends ExecutionBot {
	
	public static long placedTime = 0;
	...
	public void enter(ExecutionContext context) {
		lp(context).placeOrder(orderSpec())
			.onReply((orderRef, c) -> { placedTime = System.currentTimeMillis(); System.err.println("done ----- "); this.orderRef = orderRef; })
